...
## Reflections
cuban_pete_reflection = Reflection.create!(place: cuban_pete, date_visited: DateTime.new(2019, 11, 20), rating: 7, content: "The best go to place for good food and drinks. Always a great time! However, it's always super crowded and loud so it's better to just eat and go")
...
horizons_reflection = Reflection.create!(place: horizons, date_visited: DateTime.new(2018, 8, 17), rating: 8, content: "So. Much. Food. And it's all so delicious! Highlights include the prime rib with au jus and mashed potatoes.")
abbey_burger_bistro_reflection = Reflection.create!(place: abbey_burger_bistro, date_visited: DateTime.new(2018, 8, 16), rating: 4, content: "Your average burger place, nothing special. Not bad... but not good.")
...
green_mountain_reflection = Reflection.create!(place: green_mountain, date_visited: DateTime.new(2017, 7, 7), rating: 10, content: "Never visited before but definitely want to go back. So interesting to see all the different coffee & tea they had that I've never seen down by home before. Plus it was good~")
